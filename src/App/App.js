  ...
  return (<Router>
    <div className="">
      <Switch>
        ...
        <Route path='/home/Miscellaneous/:plat' component={Contenedorinstruccion} />
        ...
        <Route path='/home/Vegetarian/:plat' component={Contenedorinstruccion} />
        <Route path='/home/Breakfast/:plat' component={Contenedorinstruccion} />
